...
<?php
                            ...
                            $result = $sLink->query("select * from books where tm='book' limit 1000"); 
...
?>
							<tr>
                                ...
                                <td	style="text-align:center; width:5px;"><?php echo $num_rows; ?></td>
								<td	style="text-align:left;" width="25"><?php echo $row['title']; ?></td>
								<td	style="text-align:left;" width="15"><?php echo $author; ?></td>
 								<td	style="text-align:left;" width="25"><?php echo $publisher; ?></td>
     							<td	style="text-align:left;"><?php echo $taon; ?></td>
								<td	style="text-align:left;"><?php echo $prefix; ?></td>
 								<td	style="text-align:left;" width="15"><?php echo $callnumber; ?></td>                           
							</tr>
