	...
	echo "<table id='hits'><tr><th width='5'>Number</th><th width='50'>Title</th></th><th width='5'>Copy</th></tr>";
		...
		elseif ($desc=='se')
		{
			...
			echo "<tr class='save_mem<?php echo $bkid ?>'>
				...
				<td align='center' width='3'>$num_rows $desc &nbsp;<input type='checkbox' name='id[]' class='save_virtual_record' value='$bkid' </td>";
...
?>
                             ...
                             <ol>
                            <li><a href='#' onclick="document.getElementById('id01).style.display='block';"><button class='button' name="btn_virtual_shelf" type= "submit" id="btn_virtual_shelf" style='color:navy;'>Add to virtual shelf</button></a>
                            </li>
                            </ol>	  
...
<script type="text/javascript">
    $(document).ready(function() {
         ...
         $('#btn_virtual_shelf').click(function(){

          if(confirm("Are you sure you want to save in your virtual shelf the selected records?"))
          {
           var id = [];
           ...
           {
            $.ajax({
             url:'save_virtual_shelf_ajax.php',
             method:'POST',
             data:{id:id},
             success:function()
             {
