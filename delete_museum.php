    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> DELETE MUSEUM ITEM RECORD</h2>
...
<?php
$query = $sLink->query("select * from museum where museumid='$ID'");
...
if (isset($_POST['delete'])) {
    ...
    header('location:list_of_museum.php');
