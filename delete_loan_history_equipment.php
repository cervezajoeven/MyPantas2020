...
<?php
$query = $sLink->query("select * from equipment_history where id='$ID'");
					...
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">
					  ...
					  <div class="form-group">
 					  ...
 					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="title" value="<?php echo $row['description']; ?>" class="form-control" id="title" placeholder="Date...">
						</div>
					  </div>   
...
if (isset($_POST['delete'])) {
    $sql = "delete from equipment_history where id = '$id' ";
