...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Analytic and Literature Index</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> EDIT ANALYTIC AND LITERATURE INDEX</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<a href="list_of_analytics.php"><button class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Back</button></a>
					</div>
  ...
  ?>
					...
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">	
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str2" value="<?php echo $TitleStr[3]; ?>" class="form-control" id="book" placeholder="Title of book....."  />
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str3" value="<?php echo $TitleStr[4]; ?>" class="form-control" id="contributor" placeholder="Contributor....."  />
						</div>
					  </div>
 					  ...
 					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str4" value="<?php echo $TitleStr[5]; ?>" class="form-control" id="place" placeholder="Place of publication....."  />
						</div>
					  </div>                       
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str5" value="<?php echo $TitleStr[6]; ?>" class="form-control" id="publisher" placeholder="Publisher....."  />
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str6" value="<?php echo $TitleStr[7]; ?>" class="form-control" id="date" placeholder="Date of publication...."  />
						</div>
					  </div>
 					  ...
 					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str7" value="<?php echo $TitleStr[8]; ?>" class="form-control" id="pages" placeholder="Pagination...."  />
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str10" value="<?php echo $TitleStr[11]; ?>" class="form-control" id="location" placeholder="Location....."  />
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str11" value="<?php echo $TitleStr[12]; ?>" class="form-control" id="electronic_access" placeholder="Electronic access....."  />
						</div>
					  </div>		
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str12" value="<?php echo $TitleStr[13]; ?>" class="form-control" id="subject" placeholder="Subject or keyword....."  />
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
							<textarea class="form-control" rows="5" id="abstract" name="str13"><?php echo $TitleStr[14]; ?></textarea>
						</div>
					  </div>
					  <div class="form-group">
...
if (isset($_POST['update'])) {
						...
						echo "<script>alert('Successfully updated analytic and literature index information!'); window.location='list_of_analytics.php'</script>";
						}
