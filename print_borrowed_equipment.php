...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">CURRENT EQUIPMENT ON-LOAN LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from equip_borrower order by description"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
                                    ...
                                    <th style="width:150px;">Date borrowed</th>
