    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> EQUIPMENT LOAN HISTORY ITEM DETAILS</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<a href="list_of_loan_history_equipment.php"><button class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Back</button></a>
					</div>

<?php
  $stmt = $sLink->query("select * from equipment_history where id='$ID'");
...
?>					
				...
				<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:5px;">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <input type="text" name="str6" value="<?php echo $row['group_type']; ?>" class="form-control" id="type" placeholder="Group...."  />
						</div>
					  </div>  					  
...
echo "<script>window.location='list_of_loan_history_equipment.php'</script>";
