...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">PATRON ATTENDANCE LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from clientlog order by name, id, petsa"); 
...
?>
							<tr>                                
								...
								<td	style="text-align:left;"><?php echo $row['grp']; ?></td>
 								<td	style="text-align:left;"><?php echo $row['level']; ?></td>
    							<td	style="text-align:left;"><?php echo $row['petsa']; ?></td>                            
