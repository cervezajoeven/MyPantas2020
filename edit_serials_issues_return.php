...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Serials Item Returning</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> SERIAL ISSUE RETURNING</h2>
...
?>					
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-7">
						  <button type="submit" name="update" class="btn btn-primary"><i class="glyphicon glyphicon-check"></i> Return</button>
						</div>
					  </div>
					</form>
...
{
                        $sql = " UPDATE serials SET idnum='$idnumber', datein='$datein' WHERE idd = '$id' ";
                        $sLink->exec($sql); 
    
							//mysql_query(" UPDATE serials SET idnum='$idnumber', datein='$datein' WHERE idd = '$id' ")or die(mysql_error());
    
							echo "<script>alert('Successfully returned serials item issue!'); window.location='list_of_serials.php'</script>";
