...
// senayan version
define('SENAYAN_VERSION', 'SLiMS 8.2 (Akasia)');
...
$sysconf['mysqldump'] = 'C:/Program Files/MySQL/MySQL Server 5.5/bin/mysqldump.exe';
...
if (!defined('DB_NAME')) { define('DB_NAME', 'senayan'); }
if (!defined('DB_USERNAME')) { define('DB_USERNAME', 'root'); }
if (!defined('DB_PASSWORD')) { define('DB_PASSWORD', 'divine'); }
// database connection
