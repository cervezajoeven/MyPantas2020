...
if ($TitleStr[4] <> "") {
	if ($TitleStr[9] <> "" && $TitleStr[10] <> "" && $TitleStr[11] <> "") {
        ...
        $apa = '(' . trim($TitleStr[11]) . '). ' . trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . '.';
        $mla = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';      
        $chicago = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';         
    }

	elseif ($TitleStr[9] == "" && $TitleStr[10] <> "" && $TitleStr[11] <> "")
	{
        $pub = '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';       
        $apa = '(' . trim($TitleStr[11]) . '). ' . trim($TitleStr[1]) . '. N.p. : ' . trim($TitleStr[10]) . '.';
        $mla = trim($TitleStr[1]) . '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';
        $chicago = trim($TitleStr[1]) . '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';           
	}
	elseif ($TitleStr[9] <> "" && $TitleStr[10] == "" && $TitleStr[11] <> "")
	{
        $pub = trim($TitleStr[9]) . ': ' . 'n.p., '  . trim($TitleStr[11]) . '.';              
        $apa = '(' . trim($TitleStr[11]) . '). ' . trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': n.p.';   
        $mla = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . 'n.p., '  . trim($TitleStr[11]) . '.';      
        $chicago = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) .': ' . 'n.p., '  . trim($TitleStr[11]) . '.';    
        
	}
	elseif ($TitleStr[9] <> "" && $TitleStr[10] <> "" && $TitleStr[11] == "")
	{
        $pub = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';        
        $apa = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . '.';      
        $mla = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';      
        $chicago = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';           
	}
    
    $apa =  trim($TitleStr[4]) . '. ' . $apa;     
    $mla =  trim($TitleStr[4]) . '. ' . $mla;
    $chicago =  trim($TitleStr[4]) . '. ' . $chicago;   
...
else
{
   	if ($TitleStr[9] <> "" && $TitleStr[10] <> "" && $TitleStr[11] <> "") {
        $pub = trim($TitleStr[9]) . ' : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';
        $apa = '. (' . trim($TitleStr[11]) . '). ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . '.';
        $mla = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';      
        $chicago = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';         
    }
	...
	{
        $pub = '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';      
        $apa = '. (' . trim($TitleStr[11]) . '). N.p. : ' . trim($TitleStr[10]) . '.';
        $mla = trim($TitleStr[1]) . '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';
        $chicago = trim($TitleStr[1]) . '. N.p. : ' . trim($TitleStr[10]) . ', ' . trim($TitleStr[11]) . '.';           
	}
	elseif ($TitleStr[9] <> "" && $TitleStr[10] == "" && $TitleStr[11] <> "")
	{
        $pub = trim($TitleStr[9]) . ': ' . 'n.p., '  . trim($TitleStr[11]) . '.';         
        $apa = '. (' . trim($TitleStr[11]) . '). ' . trim($TitleStr[9]) . ': n.p.';
        $mla = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . 'n.p., '  . trim($TitleStr[11]) . '.';      
        $chicago = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) .': ' . 'n.p., '  . trim($TitleStr[11]) . '.';    
	...
	{
        $pub = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';           
        $apa = trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . '.';
        $mla = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';      
        $chicago = trim($TitleStr[1]) . '. ' . trim($TitleStr[9]) . ': ' . trim($TitleStr[10]) . ', ' . ', n.d.';           
	}
    
    $apa =  trim($TitleStr[1]) . '. ' . $apa;     
    $mla =  trim($TitleStr[1]) . '. ' . $mla;
    $chicago =  trim($TitleStr[1]) . '. ' . $chicago;  
}
                                        ...
                                        if ($opt == "submit_shelf"){
                                            ...
                                            if ($found==0){
                                                ...
                                                
                                                {
                                                    ...
                                                    $sql = "INSERT INTO vshelf (title,author,publication,pub_date,idnum,call_number,location,name) VALUES ('$title','$creator','$pub','$pub_date','$idnum','$call','$location','$name')";
                                                    $sLink->exec($sql);
                                                }
			 ...
			 <tr>
				...
				<td border="0" rowspan="100%" valign="top" cellpadding="">
     				<div style="width:200px;float:right; text-align:center; color:orange; background:; font-family:arial">
                        ...
                        <?php } else { ?>
                            <i class="fa fa-book" style="font-size:200px" title="Book and manuscript"></i>
                        <?php } ?>
      				</div>
			    </td>				
				</tr>
		 ...
		 <?php
			...
			<tr>
				...
				<td >
 				...
 				<td >
                        <a href='#?accession=<?php echo $acc; ?>' onclick="document.getElementById('idhold').style.display='block'">  <button class='button' style='color:navy;'>Put on-hold</button></a>
				</td>               
            ...
            <tbody>
                	...
                	<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:10px;">
                          <center>     
                            <div class="w3-container">                  
                            <div id="idhold" class="w3-modal w3-animate-opacity ">  
                              <div class="w3-modal-content">  
                                  
                                  
                                <header class="w3-container w3-aqua"> 
                                  <span onclick="document.getElementById('idhold').style.display='none'" 
                                  class="w3-button w3-display-topright">&times;</span>
                                  <h3>Put On-hold</h3>
                                </header>
                                            ...
                                            <div class="col-md-12 column">
                                                <div class="col-md-6 col-md-offset-3 column">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="pwd" id="search" size="60" placeholder="Enter password.." autofocus required />
                                                            <div class="input-group-btn">
                                                                <button class="btn btn-info" type="submit" name="submit" value="submit" id="submit"><i class="fa fa-search"></i> Submit </button>
                                                            </div>
                                                        </div> 
                                                </div>
                                            </div>
				...
				if (isset($_POST['submit'])){
                        ...
                        if ($opt == "submit_shelf"){
...

                            {
                                ...
                                $sLink->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                $sql = "INSERT INTO reservation (Title,Accession,IDnumber,Name) VALUES ('$title','$accession','$idnumber','$name')";
                                $sLink->exec($sql);      
