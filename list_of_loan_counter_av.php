...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">AUDIO-VISUAL LOAN COUNTER</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i>AUDIO-VISUAL LOAN COUNTER LIST</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<tbody>
                            ...
                            //    $item=$_GET['item'];
                            //    $letter = "<0025>".$item;
                                $result = $sLink->query("select * from books where tm='av' and t_timesout > 0 order by t_timesout desc");  
