...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Case Digest Indexing Module</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> CASE DIGEST INDEXING</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<?php include ('modal_add_cases.php') ?>
                        
                        <a href="print_cases_list.php" target="_blank" style="background:none;">
