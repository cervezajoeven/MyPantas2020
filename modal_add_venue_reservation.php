<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1"><i class="glyphicon glyphicon-plus"></i> Add Venue Reservation</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Venue Reservation</h4>
					  ...
					  <div class="form-group">
						...
						if (isset($_POST['submit'])){
                            if ($_POST['submit']=='selection'){
                                ...
                                $sql = "INSERT INTO venue_schedule (room,date_reservation,time_reservation,purpose,date_submitted,name,id_number,contact,subject) VALUES ('$venue','$date_reservation','$time_activity','$purpose','$date_submitted','$name','$idnumber','$contact','$subject')";

                                $sLink->exec($sql);  
                                
                                //mysql_query ("INSERT INTO venue_schedule (room,date_reservation,time_reservation,purpose,date_submitted,name,id_number,contact,subject) VALUES ('$venue','$date_reservation','$time_activity','$purpose','$date_submitted','$name','$idnumber','$contact','$subject')") or die(mysql_error());

                                }
                                echo "<script>alert('Venue reservation successfully added!'); window.location='list_of_venue_reservation.php'</script>";
