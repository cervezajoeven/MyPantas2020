						...
						<?php 
                            ...
                            if (isset($_POST['submit'])) {
								...
								if ($selected_radio == 'name') {
									$result=mysql_query("select * from venue_schedule where name like '%$keyword%' and (date_reservation between '$start' and '$end') order by room, date_reservation, time_reservation");
								   } 
								elseif ($selected_radio == 'group') {
									$result=mysql_query("select * from venue_schedule where subject like '%$keyword%' and (date_reservation between '$start' and '$end') order by room, date_reservation, time_reservation");           
								   } 
								elseif ($selected_radio == 'idnumber') {
									$result=mysql_query("select * from venue_schedule where id_number = '$keyword' and (date_reservation between '$start' and '$end') order by room, date_reservation, time_reservation");           
								   }	
								elseif ($selected_radio == 'type') {
									$result=mysql_query("select * from venue_schedule where room = '$keyword' and (date_reservation between '$start' and '$end') order by room, date_reservation, time_reservation");           
								   }
								else {
