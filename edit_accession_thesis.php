            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<a href="list_of_accession_thesis.php"><button class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Back</button></a>
					</div>
...
{
$sql = " UPDATE acctd SET accession='$accession', title='$title',author='$author',publisher='$publisher',call_number='$callnumber',ye_ar='$taon',location='$location',status='$status',type='$mtype' WHERE id = '$id' ";
$sLink->exec($sql);
//mysql_query(" UPDATE acctd SET accession='$accession', title='$title',author='$author',publisher='$publisher',call_number='$callnumber',ye_ar='$taon',location='$location',status='$status',type='$mtype' WHERE id = '$id' ")or die(mysql_error());
    
echo "<script>alert('Successfully updated academic coursework accession information!'); window.location='list_of_accession_thesis.php'</script>";
