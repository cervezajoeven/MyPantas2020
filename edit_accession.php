...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Book accession/shelflist</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> EDIT ACCESSION/SHELFLIST ITEM DETAILS</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<a href="list_of_accession.php"><button class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Back</button></a>
					</div>
...
$sLink->exec($sql);
//mysql_query(" UPDATE aclist SET accession='$accession', title='$title',author='$author',publisher='$publisher',call_number='$callnumber',isbn='$isbn',ye_ar='$taon',location='$location',status='$status' WHERE id = '$id' ")or die(mysql_error());
    
echo "<script>alert('Successfully updated accession item information!'); window.location='list_of_accession.php'</script>";
