    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> DELETE BOOK ACCESSION ITEM RECORD</h2>
...
<?php
$query = $sLink->query("select * from aclist where id='$ID'");
...
if (isset($_POST['delete'])) {
    $sql = "delete from aclist where id = '$id' ";
    // use exec() because no results are returned
    $sLink->exec($sql);
    
    //mysql_query("delete from books where bkid = '$id' ")or die(mysql_error());

    header('location:list_of_accession.php');
