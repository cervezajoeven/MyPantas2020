    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> DELETE THESAURUS ENTRY</h2>
...
<?php
$query = $sLink->query("select * from thesaurus where id='$ID'");
...
?>					
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">
					  <div class="form-group">
						<label for="locker" class="col-sm-3 control-label">Descriptor</label>
						<div class="col-sm-4">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="bkid" value="<?php echo $row['id']; ?>" class="form-control" id="ID" placeholder="MFN.....">
						</div>
					  </div>						  
...
if (isset($_POST['delete'])) {
    $sql = "delete from thesaurus where id = '$id' ";
    // use exec() because no results are returned
    $sLink->exec($sql);
    
    //mysql_query("delete from books where bkid = '$id' ")or die(mysql_error());

    header('location:list_of_thesaurus.php');
