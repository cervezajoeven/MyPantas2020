  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Marc import of Audio-visual materials</h4>
		<button type="button" class="close" data-dismiss="modal">&times;</button>			
      </div>
        
<?php  

$marcrec = file_get_contents("./file_upload/files/2.txt");
...
?>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str4" value="<?php echo $preferred; ?>" class="form-control" id="preferred" placeholder="Preferred title....."  />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str5" value="" class="form-control" id="other_creator" placeholder="Other creator....."  />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str7" value="<?php echo $corporate; ?>" class="form-control" id="corporate_body" placeholder="Corporate body....."  />
			</div>
		</div>	
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str12" value="" class="form-control" id="mda" placeholder="TERA or MDA....."  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str13" value="<?php echo $description; ?>" class="form-control" id="description" placeholder="Description....."  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str14" value="<?php echo $supp; ?>" class="form-control" id="dimension" placeholder="Supplementary materials....."  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str15" value="<?php echo $series; ?>" class="form-control" id="series" placeholder="Series title....."  />
			</div>
		</div>					  
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str16" value="<?php echo $notes; ?>" class="form-control" id="notes" placeholder="General notes....."  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str17" value="<?php echo $isbn; ?>" class="form-control" id="isbn" placeholder="ISBN....."  />
			</div>
		</div>                       
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str37" value="" class="form-control" id="url" placeholder="URL...."  />
			</div>
		</div>	
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str25" value="" class="form-control" id="accession" placeholder="Accession number...." />
			</div>
		</div>					  
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str26" value="" class="form-control" id="language" placeholder="Language of text...." />
			</div>
		</div>					  
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str28" value="" class="form-control" id="electronic_access" placeholder="Electronic access...." />
			</div>
		</div>						  
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="str40" value="" class="form-control" id="cover" placeholder="Cover image..." />
			</div>
		</div>					  
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
			<input type="text" name="entered_by" value="" class="form-control" id="entered_by" placeholder="Entered by..." />
			</div>
		</div>	
