    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> DELETE ARCHIVAL RECORD</h2>
...
<?php
$query = $sLink->query("select * from txtarchive where txtid='$ID'");
...
?>					
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="bkid" value="<?php echo $row['txtid']; ?>" class="form-control" id="barcode" placeholder="MFN.....">
						</div>
					  </div>						  
...
if (isset($_POST['delete'])) {
    $sql = "delete from txtarchive where txtid = '$id' ";
