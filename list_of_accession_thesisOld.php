            ...
            <tbody>					
				<form method="POST">   
						...
						<?php 
                            ...
                            {
							    $result= mysql_query("select * from acctd order by accession") or die (mysql_error());
			...
			<tbody>
					...
					<tr>
				        ...
				        <td class="center">
                            ...
                            <?php include('modal_accession_detail_thesis.php'); ?>
                            ...
                            <?php include('modal_delete_accession_thesis.php'); ?>
                            
                            
							<a class="btn btn-info" title="Edit detail information" href="edit_accession_thesis.php<?php echo '?item_id='.$id; ?>">
