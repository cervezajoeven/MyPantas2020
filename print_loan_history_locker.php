...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">LOCKER LOAN HISTORY LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from locker_history order by name, client_id, time_borrowed"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
									...
									<th style="width:200px;">Locker name</th>
									<th style="width:200px;">Description</th>                                    
									<th style="width:150px;">Time out</th>									<th style="width:150px;">Time in</th>                             
...
?>
							<tr>                                
								...
								<td	style="text-align:left;"><?php echo $row['client_id']; ?></td>
 								<td	style="text-align:left;"><?php echo $row['barcode']; ?></td>                             
 								<td	style="text-align:left;"><?php echo $row['locker']; ?></td>
  								<td	style="text-align:left;"><?php echo $row['level']; ?></td>                               
    							<td	style="text-align:left;"><?php echo $row['time_borrowed']; ?></td>                         
    							<td	style="text-align:left;"><?php echo $row['time_returned']; ?></td>   
