...
mysql_query(" UPDATE newequipment SET description='$description', brand='$brand', model='$model', sn='$serial', 
price='$price', mode_acquisition='$mode', barcode='$barcode', status='$status', accessories='$accessories', 
date_acquisition='$date_acquisition', ctl_number='$ctnumber', accountable='$accountability', remarks='$remarks', location='$location'  WHERE eqid = '$id' ")or die(mysql_error());
echo "<script>alert('Successfully Updated Item Info!'); window.location='item.php'</script>";
