...
if ($foundnum==0)
	...
	echo "<table id='hits'><tr><th width='5'>Number</th><th width='50'>Title</th></th><th width='5'>Copy</th></tr>";
		...
		if ($desc=='book') 
		{
			...
			$desc = '<img src="./images/rdabook.png" height="100" width="75">';
		}
		elseif ($desc=='td')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myTD1.png" height="100" width="75">';			
		}
		elseif ($desc=='av')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myAV.png" height="100" width="75">';			
		}
		elseif ($desc=='pr')
		{			
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myPeriodical2.png" height="100" width="75">';			
		}		
		elseif ($desc=='ba')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myBookArt.png" height="100" width="75">';			
		}	
		elseif ($desc=='vf')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myVF.png" height="100" width="75">';			
		}		
		elseif ($desc=='ca')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myLaw.ico" height="100" width="75">';			
		}		
		elseif ($desc=='er')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myElectronic.png" height="100" width="75">';			
		}		
		elseif ($desc=='itr')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myITR.png" height="100" width="75">';		
		}		
		elseif ($desc=='audio')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myAudio.png" height="100" width="75">';			
		}		
		elseif ($desc=='video')
				{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myVideo.ico" height="100" width="75">';			
		}		
		elseif ($desc=='museum')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myMuseum.png" height="100" width="75">';
		}	
		elseif ($desc=='archive')
		{
			...
			$desc = '<img src="./images/myTxtArchive.ico" height="100" width="75">';			
		}
		...
		elseif ($desc=='thesaurus')
		{
			...
			$desc = '<i class="fa fa-gift" style="font-size:48px" title="Thesaurus search"></i>';			
		}            
		elseif ($desc=='se')
		{
			$TitleStr[1] = str_replace("<001>", "", $MyArray1[0]);
			...
			$desc = '<img src="./images/myPeriodical.png" height="100" width="75">';			
		}		
			...
			echo "<tr>
				...
				if ($mtype=='book')
					if ($TitleStr[4] <> "")
                        ...
                        <a href='$link=$bkid'><button class='button' style='color:navy;'>Add to virtual shelf</button></a>                        
                        </li>
				...
				elseif ($mtype=='pr')
				{
					if ($TitleStr[2] <> "")
						...
						<br>
						<ol>
						<li><a href='$link=$bkid'><button class='button' style='color:navy;'>Add to virtual shelf</button></a></li>
						</ol>   
						</td>";
				...
				{
					if ($TitleStr[1] <> "")
						echo "<br>$TitleStr[1]<br>$TitleStr[2]
						<br>
						<ol>
						<li><a href='$link=$bkid'><button class='button' style='color:navy;'>Add to virtual shelf</button></a></li>
						</ol>
