...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-book"></i> AUDIO-VISUAL ACCESSION RECORDS</h2>
	...
	<div class="alert alert-info">
		<?php include ('modal_none.php') ?>   
         ...
         <a href="accession_generate_av.php" target="_blank" style="background:none;">
            <button class="btn btn-warning pull-right"> <i class="glyphicon glyphicon-inbox"></i> Generate</button>
        </a>
        
        <a href="print_av_accession_list.php" target="_blank" style="background:none;">
		...
		<button class="btn btn-warning pull-right"><i class="glyphicon glyphicon-barcode"></i> Barcode</button>
                         ...
                         <a href="export_to_csv.php?action=9" target="_blank" style="background:none;">
