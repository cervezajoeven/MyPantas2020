...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">ACQUISITION LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from acquisition order by title"); 
...
?>
							<tr>                                
								...
								<td	style="text-align:left;"><?php echo $row['author']; ?></td>
     							...
     							<td	style="text-align:center;"><?php echo $row['ye_ar']; ?></td>
								<td	style="text-align:center;"><?php echo $row['quantity']; ?></td>
 								<td	style="text-align:center;"><?php echo $row['net_price']; ?></td> 
