...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">STAFF LOGIN LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from logfile order by user_name"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
									...
									<th style="width:200px;">Date login</th>
...
?>
							<tr>                                
								...
								<td	style="text-align:left;"><?php echo $row['da_te']; ?></td>
