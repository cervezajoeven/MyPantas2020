...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-book"></i> LIST OF AUDIO-VISUAL ACCESSION RECORDS</h2>
            ...
            <tbody>					
				<form method="POST">   
						...
						<?php 
                            ...
                            {
							    $result= mysql_query("select * from accsm order by accession") or die (mysql_error());
	...
	<div class="alert alert-info">
        ...
        <a href="print_barcode_av.php" target="_blank" style="background:none;">
			...
			<tbody>
					...
					<tr>
				        ...
				        <td class="center">
                            ...
                            <?php include('modal_accession_detail_av.php'); ?>
                            ...
                            <?php include('modal_delete_accession_av.php'); ?>
                            
                            
							<a class="btn btn-info" title="Edit detail information" href="edit_accession_av.php<?php echo '?item_id='.$id; ?>">
