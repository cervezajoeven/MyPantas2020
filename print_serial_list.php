...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">PERIODICAL ITEM LIST</h5> </center>
            <br />
						  ...
						  <thead>
								<tr>
									...
									<th style="width:200px;">ISSN</th>
  									<th style="width:400px;">Frequency</th>
									<th style="width:200px;">Subject</th>   
                                    
 									<th style="width:400px;">Status</th>
									<th style="width:200px;">Rate</th>
  									<th style="width:400px;">Agent</th>
									<th style="width:200px;">Date renewed</th>                                    
...
?>
							<tr>                                
								...
								<td	style="text-align:center;"><?php echo $row['serial_title']; ?></td>
								<td	style="text-align:center;"><?php echo $row['issn']; ?></td>
  								<td	style="text-align:center;"><?php echo $row['frequency']; ?></td>
								<td	style="text-align:center;"><?php echo $row['subject']; ?></td>                 

								<td	style="text-align:center;"><?php echo $row['status']; ?></td>
  								<td	style="text-align:center;"><?php echo $row['price']; ?></td>
								<td	style="text-align:center;"><?php echo $row['agent']; ?></td>                               <td	style="text-align:center;"><?php echo $row['date_renewed']; ?></td> 
