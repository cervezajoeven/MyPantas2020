...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">VENUE RESERVATION LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from venue_schedule order by date_reservation, room"); 
