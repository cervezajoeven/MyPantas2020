...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">ACADEMIC COURSE WORKS INVENTORY LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from td_inventory order by call_number"); 
