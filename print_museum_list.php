...
<?php
                        ...
                        $result = $sLink->query("select * from museum order by title"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
									...
									<th style="width:200px;">Object Number</th>
                                    <th style="width:100px;">Prod Place</th>
                                    <th style="width:100px;">Prod Date</th>
...
<?php
                            ...
                            $TitleStr[2] = str_replace("<004>", "", $MyArray1[3]);   
							$TitleStr[3] = str_replace("<007>", "", $MyArray1[6]);
                            $TitleStr[4] = str_replace("<0010>", "", $MyArray1[9]); 
 							$TitleStr[5] = str_replace("<0011>", "", $MyArray1[10]);                               
							$TitleStr[6] = str_replace("<0029>", "", $MyArray1[28]);
...
?>
							<tr>
								...
								<td	style="text-align:left;"><?php echo $name; ?></td>
     							...
     							<td	style="text-align:left;"><?php echo $place; ?></td>
