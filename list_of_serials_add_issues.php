    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-book"></i> LIST OF LOAN HISTORY OF EQUIPMENT AND GADGET</h2>
            ...
            <tbody>					
				<form method="POST">   
                    ...
                    <div class="input-group" >
						...
						<?php 
                                                    //mysql_query ("INSERT INTO equipment_history (id_number, barcode, description, name, degree_course, date_loan, due_date, date_returned, group_type, library, charger)        
                            ...
                            if (isset($_POST['submit'])) {
								...
								elseif ($selected_radio == 'type') {
									$result=mysql_query("select * from equipment_history where group_type = '$keyword' and (date_loan between '$start' and '$end')");           
								   }
								else {
