    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-user"></i> AUDIO-VISUAL MATERIALS</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<?php include ('modal_add_av.php') ?>
                        <?php include ('modal_marc_av.php') ?>                        
                        <a href="print_av_list.php" target="_blank" style="background:none;">
