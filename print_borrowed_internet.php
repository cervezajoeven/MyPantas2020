...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">CURRENT COMPUTER ON-LOAN LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from borrowing order by computer"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
									...
									<th style="width:400px;">Computer name</th>                                 
...
?>
							<tr>                                
                                ...
                                <td style="text-align:left;"><?php echo $row['computer']; ?></td>
