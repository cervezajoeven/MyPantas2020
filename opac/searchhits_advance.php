...
if ($foundnum==0){
	echo "<center><h3><span class='label label-danger'>Sorry, no record found.</span></h3></center>";
}
else{ 
	...
	echo "<center><h3><span class='label label-danger'>Your searched found <b>$foundnum</b> result(s)!</span></h3><center>";
