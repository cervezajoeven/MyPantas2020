  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Delete Serials Issue Record</h4>
      </div>
      <div class="modal-body">
			...
			<a href="delete_query_serials_issue.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
			</div>
      </div>
    </div>
  </div>
