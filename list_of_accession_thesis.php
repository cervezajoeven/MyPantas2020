...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Academic courseworks accession list</a>
        </li>
    </ul>
</div>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-book"></i> LIST OF ACADEMIC COURSEWORKS ACCESSION RECORDS</h2>
	...
	<div class="alert alert-info">
		<?php include ('modal_none.php') ?>   
         ...
         <a href="accession_generate_thesis.php" target="_blank" style="background:none;">
            <button class="btn btn-warning pull-right"> <i class="glyphicon glyphicon-inbox"></i> Generate</button>
        </a>
        
        <a href="print_thesis_accession_list.php" target="_blank" style="background:none;">
		      <button class="btn btn-warning pull-right"> <i class="glyphicon glyphicon-print"></i> Print </button>
        </a>         
        
        <a href="print_barcode_thesis.php" target="_blank" style="background:none;">
		<button class="btn btn-warning pull-right"><i class="glyphicon glyphicon-print"></i> Barcode</button>
		</a> 
        
        <a href="export_to_csv.php?action=10" target="_blank" style="background:none;">
    ...
    <table id="galileo" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
						...
						<th width=''>Date/Year</th>
                        <th width='200px'>Publisher</th> 
                        <th width=''>Call number</th>        
