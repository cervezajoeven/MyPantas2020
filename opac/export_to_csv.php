...
$conn=mysql_connect("localhost","root","divine") or die("Could not connect");
mysql_select_db("pantasdb",$conn) or die("could not connect database");
...
if(isset($_GET["action"]))  
 {  
      ...
      elseif ($_GET["action"]==23)
     {
       ...
       elseif ($_GET["action"]==24)
     {
        $SQL = "select * from vshelf where idnum = '$idnumber' order by title";  
     }           
