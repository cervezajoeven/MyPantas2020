    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> ELECTRONIC RESOURCE CATALOGING MODULE</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<?php include ('modal_add_eresources.php') ?>
                        
                        <a href="print_eresources_list.php" target="_blank" style="background:none;">
