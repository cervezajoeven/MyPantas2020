...
<?php
                        ...
                        $result = $sLink->query("select * from txtarchive order by title"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
									...
									<th style="width:200px;">Description level</th>
...
<?php
                            ...
                            $TitleStr[1] = str_replace("<003>", "", $MyArray1[2]);
                            $TitleStr[2] = str_replace("<006>", "", $MyArray1[5]);   
							$TitleStr[3] = str_replace("<004>", "", $MyArray1[3]);
                            $TitleStr[4] = str_replace("<003>", "", $MyArray1[2]); 
 							$TitleStr[5] = str_replace("<001>", "", $MyArray1[0]);                               
							$TitleStr[6] = str_replace("<0014>", "", $MyArray1[13]);
                               
                                
							$title=$TitleStr[1];
 							$creator=$TitleStr[2];                               
							$description=$TitleStr[3];
                            $date=$TitleStr[4];
                            $code = $TitleStr[5]; 
                            $access=$TitleStr[6];
...
?>
							<tr>
								...
								<td	style="text-align:left;"><?php echo $code; ?></td>
 								<td	style="text-align:left;"><?php echo $access; ?></td>                           
							</tr>
