    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> INDEXING OF VERTICAL FILES</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<?php include ('modal_add_vf.php') ?>
                        
                        <a href="print_vf_list.php" target="_blank" style="background:none;">
