...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">AUDIO-VISUAL MATERIALS INVENTORY LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from sm_inventory order by call_number"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
                                    ...
                                    <th style="width:200px;">Inventory Date</th>
...
?>
							<tr>                                
								...
								<td	style="text-align:left;"><?php echo $row['author']; ?></td>
 								<td	style="text-align:left;"><?php echo $row['accession']; ?></td>
     							<td	style="text-align:center;"><?php echo $row['idate']; ?></td>
