    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> INDEX OF PERIODICAL LITERATURE</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						<?php include ('modal_add_articles.php') ?>
                        
                        <a href="print_articles_list.php" target="_blank" style="background:none;">
