...
<nav class="nav nav-pills nav-stacked" id="navright">    
	<br /><br /><br />
	<a href="export2txt.php?button=save&biblio=<?php echo $TitleStr[1] ?>+<?php echo $pub ?>+<?php echo $call ?>" class="menu"><img src="images/save.ico" height="20" width="20">Save</a><br />
	<a href="export2txt.php?button=print" class="menu"><img src="images/print.ico" height="20" width="20">Print</a><br />
	<a href="export2csv.php?$button=export&biblio=$call+$TitleStr[1]+$pub" class="menu"><img src="images/export.ico" height="20" width="20">Export</a><br />
	<a href="websearch.php" class="menu"><img src="images/cite.ico" height="20" width="20">Cite</a><br />
	<a href="websearch.php" class="menu"><img src="images/share.ico" height="20" width="20">Share</a><br />
	<a href="export2txt.php?button=clear" class="menu"><img src="images/empty.ico" height="20" width="20">Empty</a>	
</nav>
