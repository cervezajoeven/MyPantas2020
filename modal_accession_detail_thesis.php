  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Academic Courseworks Accession / Shelf list Item Details</h4>
      </div>
    				  ...
    				  <div class="form-group">
						...
						<div class="col-sm-6">
						  <input type="text" name="callnumber" value="<?php echo $callnumber; ?>" class="form-control" id="callnumber" />
               			...
               			<div class="form-group">
						<label for="location" class="col-sm-4 control-label">Material type</label>
						<div class="col-sm-6">
