...
<div class="table-responsive"> 
    ...
    <legend align="center"><h3>Analytic and Book article data display</h3></legend>		
    <table class="table" >
		<col width=25% >
		<col width=75% >
			 ...
			 <tr>
				...
				<td border="0" rowspan="100%" valign="top" cellpadding="">
    				<div style="width:200px;float:right;text-align:center;color:orange; background:; font-family:arial">
					   <i class="fa fa-file-image-o" style="font-size:200px" title="Analytic and literature index"></i>
      				</div>
                 </td>				
			</tr>
		  <?PHP } ?>
			...
			foreach($pieces as $element)				
				if ($element <> "" ) {?>
					<tr>
						...
						<td><a href='results.php?mtype=ba&search=<?PHP echo $element?>&submit=Submit'><B><?PHP echo $element ?></B></a></td>
					</tr>  
		  <?PHP } ?>				  
		  ...
		  <?PHP if ($TitleStr[3] <> "") {?>
			 <tr>
				<th class="display">Title of book :</th>
