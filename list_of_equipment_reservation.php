						...
						<?php 
                            ...
                            if (isset($_POST['submit'])) {
								...
								if ($selected_radio == 'name') {
                                    ...
                                    $result = $sLink->query("select * from equipmentnew_schedule where name like '%$keyword%' and (date_reservation between '$start' and '$end') order by equipment, date_reservation, time_reservation");  
								   } 
								elseif ($selected_radio == 'group') {
                                    ...
                                    $result = $sLink->query("select * from equipmentnew_schedule where subject like '%$keyword%' and (date_reservation between '$start' and '$end') order by equipment, date_reservation, time_reservation"); 
								   } 
								elseif ($selected_radio == 'idnumber') {
                                    ...
                                    $result = $sLink->query("select * from equipmentnew_schedule where id_number = '$keyword' and (date_reservation between '$start' and '$end') order by equipment, date_reservation, time_reservation"); 
								   }	
								elseif ($selected_radio == 'type') {
                                    ...
                                    $result = $sLink->query("select * from equipmentnew_schedule where equipment = '$keyword' and (date_reservation between '$start' and '$end') order by equipment, date_reservation, time_reservation"); 
								   }
								else {
                                   ...
                                   $result = $sLink->query("select * from equipmentnew_schedule where equipment = '$keyword' order by equipment, date_reservation, time_reservation");  
								}
							//}
							//else {
                            //    $keyword=$_GET['itemcode'];
    ...
    <div class="box-content">
        <div class="alert alert-info">
		  <?php include ('modal_add_equipment_reservation.php') ?>
            ...
            <a href="print_equipment_reservation_list.php" target="_blank" style="background:none;">
                  <button class="btn btn-warning pull-right"> <i class="glyphicon glyphicon-print"></i> Print </button>
            </a>
         
           <a href="export_to_csv.php?action=17" target="_blank" style="background:none;">
		...
		<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
			<thead>
				<tr>
					...
					<th width="">Date reservation</th>
					<th width="">Time reservation</th>
					<th width="">Faculty</th>
 					<th width="50px">Course/Subject</th>     
                    <th width="">Purpose</th>  
                    <th width="">Date submitted</th>  
        ...
        <table id="galileo" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                        ...
                        <th width="100px">Date reservation</th>
                        <th width="100px">Time reservation</th>
        ...
        <script type="text/javascript">
         $("#galileo").dataTable({
               'bProcessing': true,
                ...
                "ajax":{
                url :"data_equipment_reservation.php",
