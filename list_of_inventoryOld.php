                            ...
                            if (isset($_POST['submit'])) {
								...
								if ($selected_radio == 'invbatch') {
                                    ...
                                    //    $keyword = fgets($myfile); 
                                        ...
                                        $result=mysql_query("select * from inventory where accession = '$keyword[$x]'");
			...
			<tbody>
					...
					<tr>
				        ...
				        <td class="center">
                            ...
                            <?php include('modal_delete_book_inventory.php'); ?>
                            
                            
							<a class="btn btn-info" title="Edit detail information" href="edit_book_inventory.php<?php echo '?item_id='.$id; ?>">
