...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;">CURRENT LOCKER ON-LOAN LIST</h5> </center>
            <br />
...
<?php
                            ...
                            $result = $sLink->query("select * from locker_client order by locker"); 
						...
						<table class="table table-striped" border="1">
						  <thead>
								<tr>
                                    ...
                                    <th style="width:150px;">Time borrowed</th>
                                    <th style="width:150px; ">Time due</th>
...
?>
							<tr>                                
                                ...
                                <td style="text-align:center;"><?php echo $row['client_id']; ?></td>
                                ...
                                <td style="text-align:left;"><?php echo $row['time_due']; ?></td>
