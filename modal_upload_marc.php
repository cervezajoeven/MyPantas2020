<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal3"><i class="glyphicon glyphicon-plus"></i> Upload Marc file</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Upload Marc File</h4>
      </div>
      ...
      <div class="modal-body">
   				...
   				<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:5px;">
 					  ...
 					  <div class="form-group">
						<label for="marc" class="col-sm-3 control-label" >Marc record:</label>
						<div class="col-sm-9">
							<textarea class="form-control" rows="5" id="marc" name="marc"></textarea>
						</div>
					  </div>  
						...
						<div class="col-sm-9">
						  <button type="submit" name="extract" class="btn btn-primary"><i class="glyphicon glyphicon-save"></i> Extract</button>
						</div>
					  </div> 
                        ...
                        if ($_POST['submit'] == 'extract'){
                            $marcrec = $_POST['extract'];
                            //$marcrec = file_get_contents($_FILES['file']['tmp_name']);
				    ...
				    <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        //inserting into accession list       
                        //$accession = $_POST['str25'];
                        //$publisher = $_POST['str9'];
                        //$author = $_POST['str3'];
                        //$ye_ar = $_POST['str10'];
                        //$callnumber = $_POST['str24'];
