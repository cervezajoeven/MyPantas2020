...
<body style="background:#80e5ff;">
    <br />    <br />    <br />    <br />
<fieldset style = "width: 85%; margin:  0px auto; border-color: #ffd800;" > 
                ...
                <form role="form" action="" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-primary" type="submit" name="log_in"><i class="glyphicon glyphicon-import"></i>Enter</button>
                        </div>
                    </div> 
                    <br />
				    <div class="">
